...
- 최신 9월 9일 학습: [GPU 0 전체 모델 6회 완료·실제 학습 곡선·예측 PNG 72장](docs/assets/validation/2026-09-09/portable_e2e_learning_cycle_v1/README.md) — 가속도 입력 제외 후보는 품질 기준 미달로 미채택
- 모델 역할과 비교 방향: [자체 Portable 개발과 VAD·VisionPilot 활용](docs/portable-e2e-visionpilot-comparison.md) — VisionPilot은 조사 단계이며 아직 실행·교체하지 않았습니다.
