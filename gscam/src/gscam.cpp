...
bool GSCam::init_stream()
{
  ...
  if (image_encoding_ == "jpeg") {
    jpeg_pub_ =
      ...
      "/sensing/camera/traffic_light_recognition/image_raw/compressed", qos);
    cinfo_pub_ = create_publisher<sensor_msgs::msg::CameraInfo>(
      "/sensing/camera/traffic_light_recognition/camera_info", qos);
  } else {
    camera_pub_ = image_transport::create_camera_publisher(
      this, "/sensing/camera/traffic_light_recognition/image_raw", qos.get_rmw_qos_profile());
  }
  return true;
}
