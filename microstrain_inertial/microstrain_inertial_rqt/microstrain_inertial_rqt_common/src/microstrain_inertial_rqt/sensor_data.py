...
class SensorDataWidget(MicrostrainWidget):
  ...
  def _configure(self):
    ...
    self._imu_monitor = ImuMonitor(self._node, self._node_name, "sensing/imu/data") # HH_240219 # imu/data
    self._mag_monitor = MagMonitor(self._node, self._node_name, "sensing/imu/mag") # HH_240219 # mag
