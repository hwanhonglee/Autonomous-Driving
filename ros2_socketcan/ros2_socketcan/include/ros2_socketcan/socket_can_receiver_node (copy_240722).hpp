...
#include <autoware_auto_vehicle_msgs/msg/steering_report.hpp> //HH_230308
#include <autoware_auto_vehicle_msgs/msg/velocity_report.hpp> //HH_230314
// HH_240409
...
private:
  ...
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::HazardLightsReport>> vehicle_status_hazard_lights_status_topic_; // TODO
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::TurnIndicatorsReport>> vehicle_status_turn_indicators_status_topic_; // TODO
