...
private:
  ...
  //HH_230309
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::SteeringReport>> current_steering_angle_status_topic_;
  //HH_230314
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::VelocityReport>> current_velocity_status_topic_;
  //HH_230401
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::SteeringReport>> current_steering_angle_status_topic_for_rviz_;
  //HH_230704
  std::shared_ptr<lc::LifecyclePublisher<std_msgs::msg::Float64>> current_steering_tire_angle_topic_;

  //HH_230804
  std::shared_ptr<lc::LifecyclePublisher<std_msgs::msg::UInt8>> current_gear_state_topic_;
