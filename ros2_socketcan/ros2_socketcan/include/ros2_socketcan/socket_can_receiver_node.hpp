...
private:
  ...
  std::shared_ptr<lc::LifecyclePublisher<std_msgs::msg::Float64>> current_steering_tire_angle_topic_;
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::SteeringReport>> vehicle_status_steering_status_topic_;
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::SteeringReport>>   vehicle_status_steering_status_rviz_topic_; // HH_240814
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::VelocityReport>> vehicle_status_velocity_status_topic_;
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::GearReport>> vehicle_status_gear_status_topic_;
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::ControlModeReport>> vehicle_status_control_mode_topic_;
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::HazardLightsReport>> vehicle_status_hazard_lights_status_topic_;
  std::shared_ptr<lc::LifecyclePublisher<autoware_auto_vehicle_msgs::msg::TurnIndicatorsReport>> vehicle_status_turn_indicators_status_topic_;
