...
private:
  ...
  // void current_steering_callback(const autoware_vehicle_msgs::msg::SteeringReport::SharedPtr msg);
  // void current_throttle_callback(const autoware_control_msgs::msg::acceleration::SharedPtr msg);
