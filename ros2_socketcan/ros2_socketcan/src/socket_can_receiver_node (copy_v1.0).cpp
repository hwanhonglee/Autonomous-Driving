      ...
      switch(frame_msg.id)
      {
        ...
        { 
          ...
          if ((current_cruise_status == 1) && (current_cruise_mode == false))
          {
            ...
            // HH_240409
            autoware_vehicle_msgs::msg::ControlModeReport vehicle_status_control_mode_msg(rosidl_runtime_cpp::MessageInitialization::ZERO);
        ...
        {           
          ...
          //HH_230816
          autoware_vehicle_msgs::msg::VelocityReport vehicle_status_velocity_status_msg(rosidl_runtime_cpp::MessageInitialization::ZERO);
