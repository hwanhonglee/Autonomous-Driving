...
# HH_260906 - Record only the five isolated Portable E2E shadow evidence topics.
topic_regex+='planning/portable_e2e/status|'
topic_regex+='planning/portable_e2e/latency_ms|'
topic_regex+='planning/portable_e2e/selected_candidate|'
topic_regex+='planning/portable_e2e/shadow_path|'
topic_regex+='planning/portable_e2e/shadow_trajectory|'
