...
def generate_launch_description():
    ...
    params_file = LaunchConfiguration("vehicle_param_file").perform({})
    vehicle_info = get_vehicle_info(yaml.safe_load(open(params_file, 'r')))
    mirror_params_file = LaunchConfiguration("vehicle_mirror_param_file").perform({})
    mirror_info = get_vehicle_mirror_info(mirror_params_file)

    cropbox_parameters_self = {
        "negative": True,
