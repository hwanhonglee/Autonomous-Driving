...
{
  twist_buffer_.push_front(twist); //HH_240110
...
bool VehicleStopCheckerBase::isVehicleStopped(const double stop_duration) const   // HH_240110 for Moving state convert to stopped 
{
  if (twist_buffer_.empty()) {
    return false; // HH_240110 // false
  }
