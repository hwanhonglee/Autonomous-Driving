...
// MPCMatrix MPC::generateMPCMatrix(
//   const mpc_lateral_controller::MPCTrajectory & reference_trajectory, const double prediction_dt, const geometry_msgs::msg::Pose & current_pose)
// HH_240111
MPCMatrix MPC::generateMPCMatrix(
  const mpc_lateral_controller::MPCTrajectory & reference_trajectory, const double prediction_dt, const geometry_msgs::msg::Pose & current_pose, MPCData * data)
{
  ...
  double heading_angle_dob = tf2::getYaw(data->nearest_pose.orientation); //HH_240111
