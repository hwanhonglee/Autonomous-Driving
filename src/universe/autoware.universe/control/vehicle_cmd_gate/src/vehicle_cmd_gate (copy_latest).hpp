...
private:
  ...
  // HH_240216 
  // Publisher for goal_reached 
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr pub_goal_reached_;   
  // HH_240304
  rclcpp::Publisher<autoware_ad_api::routing::RouteState>::SharedPtr pub_routing_mode;     
  ...
  rclcpp::Subscription<geometry_msgs::msg::PoseWithCovarianceStamped>::SharedPtr sub_current_pose_; 
  // Subscriber for current vehicle pose 
  rclcpp::Subscription<visualization_msgs::msg::MarkerArray>::SharedPtr sub_goal_marker_; 
  // Subscriber for current vehicle pose 
  rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr sub_goal_pose_;
  // Variables to store current and goal pose information and goal marker 
  // HH_240216 
  ...
  // HH_240216 
  // Function to handle incoming current vehicle pose messages 
  void on_current_pose(const geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr msg); 
  // Function to handle incoming Loop Goal list pose messages 
  void on_goal_marker(const visualization_msgs::msg::MarkerArray::SharedPtr msg); 
  // Function to handle incoming Goal pose messages 
  void on_goal_pose(const geometry_msgs::msg::PoseStamped::SharedPtr msg); 
  // Function to check if the vehicle has reached the goal 
  ...
  std::vector<geometry_msgs::msg::Pose> goal_marker_poses_;
  geometry_msgs::msg::Pose goal_pose_; 
  bool current_pose_received_ = false; 
  bool goal_pose_received_ = false;   
  bool loop_goal_pose_received_ = false; 
  // HH_240216 
