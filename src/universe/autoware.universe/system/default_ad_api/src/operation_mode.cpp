...
: Node("operation_mode", options)
{
  ...
  mode_available_[OperationModeState::Message::AUTONOMOUS] = true; //HH_230419 
...
void OperationModeNode::update_state()
{
  ...
  //HH_240110
  state.is_autoware_control_enabled = (curr_state_.mode == OperationModeState::Message::AUTONOMOUS) &&
                                      mode_available_[OperationModeState::Message::AUTONOMOUS];
