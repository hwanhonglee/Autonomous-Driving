  ...
  z_margin_for_ground_removal_(declare_parameter("z_margin_for_ground_removal", 0.8))
{
  ...
  // HH_230627
  // transform_probability_for_rviz_pub_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("transform_probability", 10);
  // nearest_voxel_transformation_likelihood_for_rviz_pub_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("ndtnearest_voxel_transformation_likelihood_marker", 10);
  // no_ground_transform_probability_for_rviz_pub_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("no_ground_transform_probability", 10);
  // no_ground_nearest_voxel_transformation_likelihood_for_rviz_pub_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("no_ground_nearest_voxel_transformation_likelihood", 10);
