...
private:
  ...
  //HH_230419
  void heading2callback(const novatel_gps_msgs::msg::NovatelHeading2::SharedPtr msg);
  ...
  rclcpp::Subscription<gps_msgs::msg::GPSFix>::SharedPtr autoware_orientation_sub_;
  
  //HH_230419
  rclcpp::Subscription<novatel_gps_msgs::msg::NovatelHeading2>::SharedPtr ego_heading_sub_;
