  ...
  gnss_pose_pub_method(declare_parameter<int>("gnss_pose_pub_method"))
{
  ...
  //HH_230419 // ban // HH_240320
  // ego_heading_sub_ = create_subscription<novatel_gps_msgs::msg::NovatelHeading2>("/sensing/gnss/heading2", rclcpp::QoS{1},std::bind(&GNSSPoser::heading2callback, this, std::placeholders::_1));
  ...
  //HH_231016 // ban // HH_240320
  // current_yaw_pub_ = create_publisher<std_msgs::msg::Float64>("current_yaw", rclcpp::QoS{1});
}

//HH_230419 // ban // HH_240320
// void GNSSPoser::heading2callback(const novatel_gps_msgs::msg::NovatelHeading2::SharedPtr msg)
// {
//   ego_heading = M_PI + (msg->heading * M_PI / 180.0); //rad
//   q.setRPY(0, 0, ego_heading);
  
//   //HH_231016
//   std_msgs::msg::Float64 current_yaw_msg;
//   current_yaw_msg.data = ego_heading;
  ...
  const sensor_msgs::msg::NavSatFix::ConstSharedPtr nav_sat_fix_msg_ptr)
{
  ...
  // gnss_base_pose_msg.pose.position.x = gnss_base_pose_msg.pose.position.y - 4054315.496047;

  // HH_240321 // lat_long // sensing/gnss/fix data type
  // gnss_base_pose_msg.pose.position.x = gnss_base_pose_msg.pose.position.x - 36.62438409;
  // gnss_base_pose_msg.pose.position.x = gnss_base_pose_msg.pose.position.y - 127.45583925;

  // HH_240327 // set, sensing/gnss/pose_with_covariance data 
  gnss_base_pose_msg.pose.position.x = gnss_base_pose_msg.pose.position.x - 61928.920906187035;
  gnss_base_pose_msg.pose.position.x = gnss_base_pose_msg.pose.position.y - 54315.49627994234;
