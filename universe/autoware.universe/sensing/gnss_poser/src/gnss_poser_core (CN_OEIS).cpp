  ...
  const sensor_msgs::msg::NavSatFix::ConstSharedPtr nav_sat_fix_msg_ptr)
{
  ...
  //HH_230414
  gnss_base_pose_msg.pose.position.x = gnss_base_pose_msg.pose.position.x - 320630.517288;
  gnss_base_pose_msg.pose.position.y = gnss_base_pose_msg.pose.position.y - 4068994.207885;
  //HH_230925
  gnss_base_pose_msg.pose.position.z = gnss_base_pose_msg.pose.position.z - 54.607800;
  //HH_230419
  ...
  //HH_230414
  gnss_base_pose_cov_msg.pose.pose.position.x = gnss_base_pose_msg.pose.position.x - 320630.517288;
  gnss_base_pose_cov_msg.pose.pose.position.y = gnss_base_pose_msg.pose.position.y - 4068994.207885;
  gnss_base_pose_cov_msg.pose.pose.position.z = gnss_base_pose_msg.pose.position.z - 54.607800;
  //HH_230419
