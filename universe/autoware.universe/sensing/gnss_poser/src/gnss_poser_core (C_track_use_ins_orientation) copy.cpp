  ...
  const sensor_msgs::msg::NavSatFix::ConstSharedPtr nav_sat_fix_msg_ptr)
{
  ...
  //HH_230414
  gnss_base_pose_msg.pose.position.x = gnss_base_pose_msg.pose.position.x - 360965.999225;
  gnss_base_pose_msg.pose.position.x = gnss_base_pose_msg.pose.position.y - 4065972.492659;
  //HH_230419
