    ...
    std::make_shared<gps_msgs::msg::GPSFix>())
{
  ...
  autoware_orientation_sub_ = create_subscription<gps_msgs::msg::GPSFix>("autoware_orientation", rclcpp::QoS{1}, std::bind(&GNSSPoser::callbackGnssInsOrientationStamped, this, std::placeholders::_1));
  //HH_230419
  ego_heading_sub_ =
...
void GNSSPoser::callbackGnssInsOrientationStamped(
  ...
  const gps_msgs::msg::GPSFix::ConstSharedPtr msg)
{
