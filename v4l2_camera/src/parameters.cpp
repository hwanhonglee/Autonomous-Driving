...
{
  declareParameter("video_device", "/dev/video0", "Path to video device", true); //HH_231122 for video number
  declareParameter(
...
{  //// pixel_format
  ...
  declareParameter("pixel_format", "BGR8", "Pixel format (FourCC)", str); // HH_240729 // YUYV
